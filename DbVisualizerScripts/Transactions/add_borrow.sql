BEGIN;
SELECT add_borrow(  CAST(${numkey||null||BigDecimal||nullable ds=22 dt=NUMERIC }$ AS inumkey), 
        ...
        CAST(${borrow_start|| null ||Timestamp||nullable ds=7 dt=TIMESTAMP }$ AS itdatetime,
