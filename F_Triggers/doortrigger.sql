...
INSERT INTO t_location_doors (lodor_locname_entrance, lodor_clientkey_entrance, lodor_locname_exit, lodor_clientkey_exit) 
		VALUES (new.lodor_locname_exit, new.lodor_clientkey_entrance, new.lodor_locname_entrance, new.lodor_clientkey_exit);
END IF;
RETURN NEW;
END;
